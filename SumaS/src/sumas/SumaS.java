...
public class SumaS extends javax.swing.JFrame {
     ...
     * @param dout
     */
    public SumaS(HashMap<String, Integer> uuids, HashMap<String, Integer> ids, DataInputStream din, DataOutputStream dout) {
        initComponents();
        new Thread() {
            @Override
            public void run() {
                ...
                try {
                    ...
                    Logger.getLogger(SumaS.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }.start();
    }
    ...
    public static void main(String args[]) throws IOException {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new SumaS(uuids, ids, din, dout).setVisible(true);
            }
        });
    }

...
public class RestaS extends javax.swing.JFrame {
     ...
     * @param dout
     */
    public RestaS(HashMap<String, Integer> uuids, HashMap<String, Integer> ids, DataInputStream din, DataOutputStream dout) {
        initComponents();
        new Thread() {
            @Override
            public void run() {
                ...
                try {
                    ...
                    Logger.getLogger(RestaS.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }.start();
    }
    ...
    public static void main(String args[]) throws IOException {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RestaS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new RestaS(uuids, ids, din, dout).setVisible(true);
            }
        });
    }

 ...
 * @author javav
 */
public class DivS extends javax.swing.JFrame {

    /**
     * Creates new form DivS
     *
     * @param uuids
     * @param ids
     * @param din
     * @param dout
     */
    public DivS(HashMap<String, Integer> uuids, HashMap<String, Integer> ids, DataInputStream din, DataOutputStream dout) {
        initComponents();
        new Thread() {
            @Override
            public void run() {
                try {
                    dout.writeUTF("Division");
                    while (true) {
                        ...
                        if (ids.containsKey(id)) {
                            ...
                            switch (mensaje.operacion) {
                                case '/' ->
                                    str2 = String.format("%d / %d = %d", mensaje.operador1, mensaje.operador2, mensaje.operador1 / mensaje.operador2);
                            }
                ...
                try {
                    ...
                    Logger.getLogger(DivS.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }.start();
    }
    ...
    public static void main(String args[]) throws IOException {
        ...
        System.out.printf("Soy Division \n Parámetros recibidos: \n");
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DivS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new DivS(uuids, ids, din, dout).setVisible(true);
            }
        });
    }
